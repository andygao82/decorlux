<?php
/* Template Name: Recent Projects Page */
get_header();
...
<div class="page-category-content">
    ...
    <section class="page-banner category-banner recent-projects-banner" style="background-image: url('<?= esc_url($featured_img_url)?>')">
		<?php }else{ ?>
			...
			<div class="row">
				<div class="col">
					<div class="post-image">
						<?php if (function_exists('z_taxonomy_image')) z_taxonomy_image(9); ?>
					</div>
					<div class="wrapper">
