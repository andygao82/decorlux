jQuery(document).ready(function($){
    ...
    $('#primary-menu > li.menu-item:nth-child(1)').mouseenter(function () {
        $('.site-menu').css('background-image','url(http://decorluxnew.gtechsolution.com.au/wp-content/themes/decorlux/images/curtain.jpg)');
    });

    $('#primary-menu > li.menu-item:nth-child(2)').mouseenter(function () {
        $('.site-menu').css('background-image','url(http://decorluxnew.gtechsolution.com.au/wp-content/themes/decorlux/images/sofa.jpg)');
    });

    $('#primary-menu > li.menu-item:nth-child(3)').mouseenter(function () {
        $('.site-menu').css('background-image','url(http://decorluxnew.gtechsolution.com.au/wp-content/themes/decorlux/images/decoration.jpg)');
    });
