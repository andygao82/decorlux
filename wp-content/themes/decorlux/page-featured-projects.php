<?php
/* Template Name: Featured Projects Page */
get_header();
...
<div class="page-category-content">
	...
	<?php if($featured_img_url){?>
        <section class="page-banner category-banner featured-projects-banner" style="background-image: url('<?= esc_url($featured_img_url)?>')">
	<?php }else{ ?>
			...
			<div class="row">
				<div class="col">
					<div class="post-image">
						<?php if (function_exists('z_taxonomy_image')) z_taxonomy_image(10); ?>
					</div>
					<div class="wrapper">
