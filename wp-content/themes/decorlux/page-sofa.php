...
<div class="page-category-content">
    ...
    <section class="page-banner category-banner sofa-banner" style="background-image: url('<?= esc_url($featured_img_url)?>')">
		<?php }else{ ?>
        <section class="page-banner category-banner sofa-banner">
			<?php } ?>
                ...
                <div class="row">
                    <div class="col">
                        <div class="post-image">
							<?php if (function_exists('z_taxonomy_image')) z_taxonomy_image(14); ?>
                        </div>
                        <div class="wrapper">
